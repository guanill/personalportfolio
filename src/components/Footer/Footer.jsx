  ...
  return (
    <footer className="footer" id="contact">
      <div className="container">
        ...
        <div className="footer__links reveal reveal-delay-1">
          <a
          ...
          >
            ...
            <div>
              ...
              <span className="footer__link-handle">{personalInfo.linkedinHandle}</span>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <span className="footer__link-handle">{personalInfo.githubHandle}</span>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <span className="footer__link-handle">{personalInfo.email}</span>
            </div>
          </a>
        </div>
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">
            Designed & built by <span className="footer__accent">{personalInfo.name}</span>
          </p>
